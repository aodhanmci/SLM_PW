...
class GA_weight:
    def __init__(self, SLMwidth, SLMheight):
        ...
        self.weight_population_size = self.weight_num_blocks_y *self.weight_num_blocks_x
        self.weights = np.zeros((self.weight_num_blocks_y, self.weight_num_blocks_x))
    ...
    def create_basic_block_weight_pattern(self):
        ...
        return np.tile(basic_block, (self.weight_num_blocks_y, self.weight_num_blocks_x))
    ...
    def initialize_weight_individual_block_based(self, population_number):
        ...
        initial_guess = np.zeros(( (self.weight_num_blocks_y, self.weight_num_blocks_x)))
    ...
    def apply_weight_block_pattern_to_grid(self, amplitudes):
        ...
        tiled_amplitudes = np.repeat(np.repeat(amplitudes, self.weight_block_size_y, axis=0), self.weight_block_size_x, axis=1)
